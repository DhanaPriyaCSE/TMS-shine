...
if(isset($_POST['submit1'])){
  $class=$_POST['course'];
 if($class){
  $result = mysqli_query($con,"SELECT * FROM quiz where class='$class'") or die('Error');
 }else{
...
//   <td><b><a href="update.php?q=quizre&step=25&eid='.$eid.'&n=1&t='.$total.'" class="pull-right btn sub1" style="margin:0px;background:red">
